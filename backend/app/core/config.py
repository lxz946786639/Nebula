...
class Settings(BaseSettings):
    ...
    HISTORY_CLEANUP_RETENTION_DAYS: int = 30
    HISTORY_RETENTION_SMART_PROXY_TRAFFIC_DAYS: int = 30
    HISTORY_RETENTION_ANT_PROXY_TRAFFIC_DAYS: int = 30
    HISTORY_RETENTION_AUDIT_LOG_DAYS: int = 30
    HISTORY_RETENTION_SUBSCRIPTION_TRAFFIC_DAYS: int = 30
    HISTORY_RETENTION_SMART_PROXY_STABILITY_DAYS: int = 30
    HISTORY_RETENTION_SMART_PROXY_HEALTH_LOG_DAYS: int = 30
    HISTORY_RETENTION_SMART_PROXY_SWITCH_LOG_DAYS: int = 30
    HISTORY_RETENTION_NODE_SNAPSHOT_DAYS: int = 30
