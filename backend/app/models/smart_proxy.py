...
class SmartProxy(Base):
    ...
    data_source: Mapped[str] = mapped_column(String(32), default="subscription", index=True, nullable=False)
    ...
    ant_node_ids: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False)
    ant_strategy_node_ids: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False)
    ...
    config_updated_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), default=now_china)
